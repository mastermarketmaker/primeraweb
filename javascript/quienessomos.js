// No se necesita JavaScript para el efecto hover, solo se incluye aquí como ejemplo

// JavaScript para agregar miembros del equipo dinámicamente
...
const members = [
  ...
  { name: 'Bob Johnson', position: 'Bob Johnson es un coach certificado en inteligencia emocional con amplia experiencia en ayudar a personas de diferentes edades y entornos a entender y regular sus emociones para mejorar su calidad de vida. Bob utiliza una combinación de técnicas de coaching y las últimas investigaciones en inteligencia emocional para enseñar habilidades como la autoconciencia, la regulación emocional, la empatía y las habilidades sociales.', image: '../imagenes/testimonio3.jpg' },
];
